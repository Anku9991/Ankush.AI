# 🚀 Guide: Deploying PIHNEXA TECHNOLOGIES to Vercel
...
3. Name it `pihnexa-technologies-website` and set it to **Public**.
...
5. On your computer, open the terminal in your project folder and run:
   ...
   git branch -M main
   git remote add origin https://github.com/YOUR_GITHUB_USERNAME/pihnexa-technologies-website.git
...
3. You will see your `pihnexa-technologies-website` repository. Click **Import**.
4. Leave all settings as default (Framework: Other, Build Command: default).
5. Click **Deploy**.

## 4. Get your Live Link
- After a few seconds, Vercel will give you a link like `pihnexa-technologies-website.vercel.app`.
- Every time you update your code and push to GitHub, Vercel will automatically update your website!

---
### 💡 Professional Tip
- **Custom Domain**: You can connect a custom domain like `PIHNEXA.ai` later in the Vercel Settings > Domains tab.
